...
public class Tourney {
    ...
    ArrayList<ArrayPlayers<Player>> arrayFullPlayers;
...
//            } else
    ...
    public void transition() {
        for (int i = 0; i < leagueFactory.findLeagues(LeagueType.Gold).getArrayPlayers().size(); i++) {
            ...
            if (leagueFactory.findLeagues(LeagueType.Silver).getArrayPlayers().get(i).getPlayer().getPoint() > 50) {
                replaceLeague(leagueFactory.findLeagues(LeagueType.Bronze).getArrayPlayers().get(i), leagueFactory.findLeagues(LeagueType.Gold).getArrayPlayers(), leagueFactory.findLeagues(LeagueType.Silver).getArrayPlayers());
    ...
    public ArrayList<ArrayPlayers<Player>> getArrayFullPlayers() {
        return arrayFullPlayers;
    }

    public void setArrayFullPlayers(ArrayList<ArrayPlayers<Player>> arrayFullPlayers) {
        this.arrayFullPlayers = arrayFullPlayers;
    }
}
